#ifndef ROBOT_INSTANCE_FRANKA_SIMULATION_HPP_
#define ROBOT_INSTANCE_FRANKA_SIMULATION_HPP_
...
class RobotInstanceFrankaSimulation: public RobotInstance
{
public:
    /**
     * @brief Construct a new Robot Instance Franka Simulation object
     * 
     * @param name the topic the action server should listen to for incoming goals
     * @author Ties Klappe
     */
    explicit RobotInstanceFrankaSimulation(const std::string& name);

    /**
     * @brief Destroy the Robot Instance Franka object
     * @author Ties Klappe
     */
    virtual ~RobotInstanceFrankaSimulation();
private:
     ...
     * function will be called when a preprogrammed position is requested and the Franka Simulation is attached
     * 
...
#endif //ROBOT_INSTANCE_FRANKA_SIMULATION_HPP_