...
public:
     ...
     */
    std::string configurationToSSC32UCommandString(const franka_low_level_driver::FrankaConfigurationGoalConstPtr goal) const;
     ...
     */
    unsigned long long getLastFinishedTime(const franka_low_level_driver::FrankaConfigurationGoalConstPtr goal) const;
     ...
     */
    void setTargetPositions(const franka_low_level_driver::FrankaConfigurationGoalConstPtr goal);
