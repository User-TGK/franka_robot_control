#ifndef MOTION_GENERATOR_HPP_
#define MOTION_GENERATOR_HPP_
...
/**
 * @brief the implementation of this class if based on the LibFranka MotionGenerator example with the
 ...
 * 
 * For License and Notice details please see the franka_low_level_driver directory
 */
